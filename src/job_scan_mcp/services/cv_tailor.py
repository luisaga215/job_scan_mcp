...
<head>
    ...
    <style>
        @page { margin: 0.35in; }
        body { font-family: 'Times New Roman', Times, serif; color: #111; line-height: 1.2; font-size: 9.5pt; }
        h1 { font-size: 18pt; text-align: center; margin: 0 0 2px; font-weight: bold; }
        .contact-info { text-align: center; font-size: 8.5pt; margin: 0 0 6px; color: #111; }
        .section-title { font-size: 11pt; font-weight: bold; text-transform: uppercase; letter-spacing: 0.5px; border-bottom: 1px solid #000; margin-top: 6px; margin-bottom: 3px; }
        .company-line { font-weight: bold; font-size: 10pt; margin-bottom: 1px; }
        .item-header { display: flex; justify-content: space-between; font-size: 9.5pt; margin-bottom: 1px; }
        .item-header .title { font-style: italic; }
        .item-header .meta { font-size: 8.5pt; }
        .item-subheader { display: flex; justify-content: space-between; font-style: italic; font-size: 8.5pt; margin-bottom: 1px; }
        ul { margin-top: 0; padding-left: 16px; margin-bottom: 4px; }
        li { margin-bottom: 1px; }
        .summary { margin: 0 0 5px; font-size: 9.5pt; }
        .skills-container { margin-bottom: 3px; }
        .skill-row { margin-bottom: 1px; font-size: 9.5pt; }
